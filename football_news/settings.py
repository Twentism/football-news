...
SECRET_KEY = 'django-insecure--z0y)64ki^al9g1an!jvz!t=0vkr%_p9nerzfc+8@5elgug)c('

# SECURITY WARNING: don't run with debug turned on in production!
PRODUCTION = os.getenv('PRODUCTION', 'False').lower() == 'true'
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "melanton-gabriel-footballnews.pbp.cs.ui.ac.id", "10.0.2.2"]

CSRF_TRUSTED_ORIGINS = [
    "https://melanton-gabriel-footballnews.pbp.cs.ui.ac.id"
]
